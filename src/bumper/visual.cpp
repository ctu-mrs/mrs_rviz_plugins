...
namespace mrs_rviz_plugins
{
  ...
  namespace bumper
  {
    ...
    std::shared_ptr<rviz::Object> Visual::draw_lidar_1d(const double dist, const unsigned sector_it, const unsigned n_horizontal_sectors)
    {
    ...
    std::shared_ptr<rviz::Object> Visual::draw_lidar_2d(const double dist, const unsigned sector_it, const unsigned n_horizontal_sectors)
    {
