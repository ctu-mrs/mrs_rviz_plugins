...
OdomViz::OdomViz(){
    ...
    pose_shaft_rad_property = new rviz::FloatProperty("Shaft radius", 0.05, "Radius of the each arrow's shaft, in meters.",
                                pose_property, SLOT(on_pose_params_changed()), this);
    pose_head_len_property  = new rviz::FloatProperty("Head length", 0.3, "Length of the each arrow's head, in meters.",
                                pose_property, SLOT(on_pose_params_changed()), this); 
    pose_head_rad_property  = new rviz::FloatProperty("Head radius", 0.1, "Radius of the each arrow's head, in meters.", 
                                pose_property, SLOT(on_pose_params_changed()), this);

    //      Axes
    pose_axes_len_property = new rviz::FloatProperty("Axes length", 1, "Length of each axis, in meters.",
                                pose_property, SLOT(on_axes_params_changed()), this);
    pose_axes_rad_property = new rviz::FloatProperty("Axes radius", 0.1, "Radius of each axis, in meters",
                                pose_property, SLOT(on_axes_params_changed()), this);
    ...
    vel_shaft_len_property = new rviz::FloatProperty("Shaft length", 1, "Length of the each arrow's shaft, in meters", 
                                vel_property, SLOT(on_vel_params_changed()), this);
    vel_shaft_rad_property = new rviz::FloatProperty("Shaft radius", 0.1, "Radius of the each arrow's shaft, in meters.", 
                                vel_property, SLOT(on_vel_params_changed()), this);
